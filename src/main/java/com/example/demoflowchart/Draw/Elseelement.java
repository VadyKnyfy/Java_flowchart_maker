...
public class Elseelement extends Drawflows{
    ...
    public Elseelement(BaseElem element, double corIflinesize, Point2D startPoints) {
        ArrayList<Point2D> ifelemAL = new ArrayList<Point2D>();
        Group group = new Group();
        baseElem = element;
        System.out.println(startPoints + "sp-elp");
        Point2D endpoint = startPoints;
        ...
        label.setY((elseline.getStartY() + elseline.getEndY()) / 2 - 2);
        ...
        for(BaseElem elem: element.getElemArrayList()){
            switch (elem.getType()){
                ...
                case "if":{
                    ...
                    System.out.println(i + "w1idth="+getMinMaxX(ifelement.getinsideGroup())[1]);
                    ...
                    System.out.println(i + "w2idth="+getMinMaxX(ifelement.getinsideGroup())[1]);
                    try{
